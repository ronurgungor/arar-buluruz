...
async function assertNoHorizontalOverflow(page, profile, route) {
...
async function assertCleanRuntime(runtimeErrors, profile) {
  assert(
...
async function runProfile(browser, profile) {
  ...
  await assertCleanRuntime(runtimeErrors, profile.name);
  await context.close();
