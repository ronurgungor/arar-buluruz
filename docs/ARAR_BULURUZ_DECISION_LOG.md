...
- **Later canary:** one sentynthetic current submission → public delivery/signed photo → founder post-moderation takedown path against actual managed provider APIs, without duplicating the entire canonical Stage 1 acceptance suite.
