  ...
  return (
    <PublisherInfoPage
      ...
      sections={[
        ...
        {
          title: "4. Sorunlu ilanı bildir",
          paragraphs: [
            "Yanıltıcı, yasak veya şüpheli bir ilan gördüğünde mevcut şikâyet kanalını kullanabilirsin. İnceleme sonucunda ilan yayından kaldırılabilir; şikâyet mekanizması bir ödeme veya uyuşmazlık çözüm garantisi değildir.",
          ],
        },
      ]}
    />
