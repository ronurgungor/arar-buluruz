...
export const Route = createFileRoute("/nasil-calisir")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "Arar Buluruz'un ilan keşfi, iletişim ve işlem sınırlarını sade biçimde açıklar." },
...
function HowItWorks() {
  return <PublisherInfoPage
    ...
    sections={[
      { title: "1. Ara ve karşılaştır", paragraphs: [
      ...
      { title: "2. İlanı ve satıcıyı değerlendir", paragraphs: [
      ...
      { title: "3. İletişim ve ödeme ayrı aşamalardır", paragraphs: [
      ...
      { title: "4. Kurucu moderasyonu", paragraphs: [
