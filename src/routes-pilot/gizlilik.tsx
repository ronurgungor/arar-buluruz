        ...
        <div className="mt-8 space-y-6 text-sm leading-6 text-foreground">
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              Yayındaki bir ilanda başlık, açıklama, fiyat, konum, satıcı görünen adı, fotoğraflar
              ve seçilen telefon veya WhatsApp iletişim bilgisi gösterilebilir. İlanlar yayın
              öncesinde kurucu tarafından incelenir; kullanıcı hesabı veya satıcı paneli bulunmaz.
            </p>
          </section>
          <section>
