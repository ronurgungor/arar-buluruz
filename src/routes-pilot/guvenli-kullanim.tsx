...
export const Route = createFileRoute("/guvenli-kullanim")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "İlan değerlendirirken dikkat edilmesi gereken temel güvenlik sınırları." },
...
function SafeUse() {
  return <PublisherInfoPage
    ...
    sections={[
      { title: "İşlemden önce kontrol et", bullets: [
      ...
      { title: "Ödeme ve üçüncü taraf bağlantıları", paragraphs: [
      ...
      { title: "Sorunlu ilanlar", paragraphs: [
